...
class HotelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hotel" do
    assert_difference('Hotel.count') do
      post hotels_url, params: { hotel: { info: @hotel.info, name: @hotel.name, price: @hotel.price } }
    end
  ...
  test "should update hotel" do
    patch hotel_url(@hotel), params: { hotel: { info: @hotel.info, name: @hotel.name, price: @hotel.price } }
